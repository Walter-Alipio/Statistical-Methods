...
public class CentralTendencyTests
{
    ...
    public void Mean_ReturnsTheCalculatedMean_FromAnIntArray(int expected, int[] values)
    {
        //Arrange
    ...
    public void Median_ReturnsTheCalculatedMedian_FromAnIntArray(int expected, int[] values)
    {
        // Given
    ...
    public void Mode_ReturnsListOfInt_WithCalculatedModeFromAnIntArray(int[] expected, int[] values)
    {
        // Given
    ...
    public void WeightAverage_ReturnsCalculatedResult_ForInputValuesAndWeights(double expected, int[] valores, int[] pesos)
    {
        // Given
    ...
    [InlineData(27, 30, 25)]
    [InlineData(22, 25, 20)]
    public void Midpoint_ReturnsCalculatedMidpoint_GivenSuperiorLimitIntValueAndInferiorLimitIntValue(double expected, int limiteSup, int limiteInf)
    {
        // Given
    ...
    public void MidpointDouble_ReturnsCalculatedMidpoint_GivenSuperiorLimitDoubleValueAndInferiorLimitDoubleValue(double expected, double limiteSup, double limiteInf)
    {
        // Given
